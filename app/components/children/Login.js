                    ...
                    <form action="/login" method="POST" onSubmit={this.handleLogin}>
                        ...
                        <div className="row">
                            <div className="col m6 s12 center">
                                <a id="loginButton" className="btn waves-effect waves-light btn-large blue accent-3" type="submit" value="Submit" name="action">Login<i className="material-icons right">send</i></a>
                            </div>
                            <div className="col m6 s12 center">
